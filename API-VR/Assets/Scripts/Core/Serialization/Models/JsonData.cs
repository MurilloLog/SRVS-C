...
[System.Serializable]
public class JsonData : ISerializationModel
{
     ...
     public void FromJson(string json)
    {
        ...
        this.anchorID = temp.anchorID;
        this.anchorPosition = temp.anchorPosition;
        this.anchorRotation = temp.anchorRotation;

        this.linePoints = temp.linePoints;
        this.lineColor = temp.lineColor;
        this.size = temp.size;

        this.IsSelected = temp.IsSelected;
        this.objectMesh = temp.objectMesh;
